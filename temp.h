...
typedef struct Lazy_Queue {
    ...
    alignas(64)
    LAZY_QUEUE_ATOMIC(uint64_t) bot; //changed by push (and pop_back)
...
LAZY_QUEUE_API_INLINE bool lazy_queue_push(Lazy_Queue *q, const void* item, isize item_size);
LAZY_QUEUE_API_INLINE bool lazy_queue_pop(Lazy_Queue *q, void* item, isize item_size);
LAZY_QUEUE_API_INLINE bool lazy_queue_pop_back(Lazy_Queue *q, void* item, isize item_size); 
...
LAZY_QUEUE_API_INLINE Lazy_Queue_Result lazy_queue_result_push(Lazy_Queue *q, void* item, isize item_size);
...
LAZY_QUEUE_API_INLINE Lazy_Queue_Result lazy_queue_result_push(Lazy_Queue *q, const void* item, isize item_size)
{
    ...
    if (a == NULL || (int64_t)(b - t) > (int64_t) a->mask) { 
        ...
        if (a == NULL || (int64_t)(b - t) > (int64_t) a->mask) { 
            ...
            if(new_a == a)
            {
                Lazy_Queue_Result out = {a, b, t, LAZY_QUEUE_FULL};
                return out;
            }
    ...
    Lazy_Queue_Result out = {a, b, t, LAZY_QUEUE_OK};
    return out;
}
...
LAZY_QUEUE_API_INLINE Lazy_Queue_Result lazy_queue_result_pop_weak(Lazy_Queue *q, void* item, isize item_size)
{
    ...
    Lazy_Queue_Result out = {NULL, b, t, LAZY_QUEUE_EMPTY};
...
LAZY_QUEUE_API_INLINE bool lazy_queue_push(Lazy_Queue *q, const void* item, isize item_size)
{
    return lazy_queue_result_push(q, item, item_size).state == LAZY_QUEUE_OK;
}
...
LAZY_QUEUE_API_INLINE bool lazy_queue_pop_back(Lazy_Queue *q, void* item, isize item_size)
{
    return lazy_queue_result_pop_back(q, item, item_size).state == LAZY_QUEUE_OK;
}
